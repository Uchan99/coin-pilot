...
| 10 | 34 | AdaptiveMeanReversion 4단계 전략 개선 (동시 포지션 제한 + MA20 exit + Analyst 프롬프트 + Guardian OHLC) | in_progress | 사용자 승인 (2026-03-27), 재승인 대기(2026-03-28 데이터 분석 반영 4단계 재편) | 동시 3심볼 SL 재발 없음 + TIME_LIMIT avg_loss 개선 + boundary_violation 20% 이하 + Guardian reasoning 품질 향상 | backtest_v3.py 비교 + 실운영 2주 후 SQL 검증 | `docs/work-plans/34_adaptive_mean_reversion_4stage_improvement_plan.md` | - |
