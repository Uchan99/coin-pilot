...
| 2 | 24 | 디스코드 모바일 조회 챗봇 | in_progress | 21-05 기본 모니터링 안정화 | `/수익률` 등 핵심 명령이 모바일 Discord에서 응답 | `docker compose --profile discord-bot ... up -d --build bot discord-bot` + Discord slash command 수동 확인 | `docs/work-plans/24_discord_mobile_chatbot_query_plan.md` | `docs/work-result/24_discord_mobile_chatbot_query_result.md`, `docs/troubleshooting/24_mobile_visibility_gap_discord_query_need.md`, `docs/troubleshooting/24-01_discord_role_nonetype_guard_fix.md` |
