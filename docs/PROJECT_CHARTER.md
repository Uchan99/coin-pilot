...
| 2026-03-06 | 21-07 운영 핫픽스 반영: promtail docker_sd의 Docker API mismatch(`1.42 < min 1.44`)를 해결하기 위해 `PROMTAIL_DOCKER_API_VERSION` 설정과 점검 스크립트 FAIL 기준 강화를 추가 |

---
*최종 업데이트: 2026-03-06 (21-07 promtail API mismatch 핫픽스 반영) by Codex (GPT-5)*
