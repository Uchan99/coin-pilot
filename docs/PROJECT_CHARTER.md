...
**진입 조건 (Long) - v2.1 (Week 8 Strategy Expansion)**
| 조건 | v1.0 (보수적) | v2.1 (완화) | 근거 |
| :--- | :--- | :--- | :--- |
| **RSI (14)** | < 30 | < **33** | RSI 33도 과매도 구간, 기회 확대 |
| **Price vs MA** | > MA 200 | > **MA 50** | RSI 과매도와 MA200 상충 문제 해결 (중기 추세로 변경) |
