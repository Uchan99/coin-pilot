...
3. `21-03` AI Decision 카나리 실험 (`in_progress`)
4. `21-04` LLM 토큰/비용 관측 대시보드 (`in_progress`)
5. `29` 레짐 전환 구간 전략 평가 + 조건부 핫픽스 (`in_progress`)
6. `22` 대시보드 가독성/실시간성 표준화(Spec-First) (`todo`)
7. `23` Next.js 점진 이관 (`blocked`)
